class Usuario:
    def _init_(self, correo, nombre_comercio, telefono_comercio, nombre_dueno, ubicacion_local):
        self.correo = correo
...
class FacturaElectronica:
    def _init_(self, tipo_cedula, numero_cedula, nombre, telefono, correo, provincia, canton, distrito):
...
class Paquete:
    def _init_(self, nombre_destinatario, telefono_destinatario, numero_cedula, peso, cobro_contra_entrega):
